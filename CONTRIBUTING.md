...
We actively manage the core Slaw feature roadmap.
...
> - This pull request adds per-adapter configuration of compaction, either auto or slaw managed
> - That way we can get optimal performance from any adapter/provider in Slaw
