import type { AssetImage } from "@slaw-ai/shared";
import { api } from "./client";

export const assetsApi = {
  uploadImage: async (squadId: string, file: File, namespace?: string) => {
    ...
    return api.postForm<AssetImage>(`/squads/${squadId}/assets/images`, form);
  },
  ...
  uploadSquadLogo: async (squadId: string, file: File) => {
    ...
    const form = new FormData();
    form.append("file", safeFile);
    return api.postForm<AssetImage>(`/squads/${squadId}/logo`, form);
  },
};
