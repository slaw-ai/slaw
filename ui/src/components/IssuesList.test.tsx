...
import type { Issue, Project } from "@slaw-ai/shared";
...
describe("IssuesList", () => {
  ...
  it("requests more server issues after scrolling past the rendered rows", async () => {
    ...
    // The fill-viewport load-more fires asynchronously; under a loaded full
    // suite the two flush() ticks were not always enough (flaky).
    await waitForAssertion(() => {
