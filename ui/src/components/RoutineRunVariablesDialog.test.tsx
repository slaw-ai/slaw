...
import type { Agent, ExecutionWorkspace, Project } from "@slaw-ai/shared";
...
function createProject(): Project {
  return {
    ...
    codebase: {
      ...
      repoName: null,
      localFolder: null,
      managedFolder: "/tmp/slaw/project-1",
      effectiveLocalFolder: "/tmp/slaw/project-1",
