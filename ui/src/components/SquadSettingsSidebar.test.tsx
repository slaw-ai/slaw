...
vi.mock("./SidebarSquadMenu", () => ({
  SidebarSquadMenu: () => <div>Workspace switcher</div>,
}));
...
describe("SquadSettingsSidebar", () => {
  ...
  it("renders the squad back link and the settings sections in the sidebar", async () => {
    ...
    expect(container.textContent).toContain("Slaw");
  ...
  it("renders squad settings pages contributed by ready plugins", async () => {
    mockUsePluginSlots.mockReturnValue({
      slots: [
        {
