...
import { AGENT_ROLE_LABELS } from "@slaw-ai/shared";
...
export const help: Record<string, string> = {
  ...
  adapterType: "How this agent runs: local CLI (Claude/Codex/OpenCode), spawned process, or generic HTTP webhook.",
  ...
  workspaceStrategy: "How Slaw should realize an execution workspace for this agent. Keep project_primary for normal cwd execution, or use git_worktree for issue-scoped isolated checkouts.",
  ...
  bootstrapPrompt: "Only sent when Slaw starts a fresh session. Use this for stable setup guidance that should not be repeated on every heartbeat.",
  payloadTemplateJson: "Optional JSON merged into remote adapter request payloads before Slaw adds its standard wake and workspace fields.",
