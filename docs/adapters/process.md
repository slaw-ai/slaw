...
- Running a Python script that calls the Slaw API
...
1. Slaw spawns the configured command as a child process
2. Standard Slaw environment variables are injected (`SLAW_AGENT_ID`, `SLAW_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Slaw API and perform work.
