...
The `plan` key is conventional and reserved by Slaw workflow/docs.
...
Update the Slaw agent workflow so planning no longer edits the issue description.

Required changes:

- update `skills/slaw/SKILL.md`
