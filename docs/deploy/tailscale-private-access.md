...
summary: Run Slaw with Tailscale-friendly bind presets and connect from other devices
---

Use this when you want to access Slaw over Tailscale (or a private LAN/VPN) instead of only `localhost`.
...
```sh
pnpm slaw allowed-hostname my-macbook.tailnet.ts.net
```
