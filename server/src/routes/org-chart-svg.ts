/**
 * Server-side SVG renderer for Slaw org charts.
...
// Slaw logo: scaled icon (~16px) + wordmark (13px), vertically centered
const SLAW_LOGO_SVG = `<g>
  ...
  <text x="22" y="11.5" font-family="system-ui, -apple-system, sans-serif" font-size="13" font-weight="600" fill="currentColor">Slaw</text>
</g>`;
