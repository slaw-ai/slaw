...
export function approvalRoutes(
  ...
  async function requireApprovalAccess(req: Request, id: string) {
    ...
    assertSquadAccess(req, approval.squadId);
    return approval;
  }

  router.get("/squads/:squadId/approvals", async (req, res) => {
    const squadId = req.params.squadId as string;
    assertSquadAccess(req, squadId);
    const status = req.query.status as string | undefined;
    const result = await svc.list(squadId, status);
  ...
  router.post("/squads/:squadId/approvals", validate(createApprovalSchema), async (req, res) => {
    const squadId = req.params.squadId as string;
    assertSquadAccess(req, squadId);
    ...
    const approval = await svc.create(squadId, {
      ...approvalInput,
