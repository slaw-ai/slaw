...
describe("agent local JWT", () => {
  const secretEnv = "SLAW_AGENT_JWT_SECRET";
  const betterAuthSecretEnv = "BETTER_AUTH_SECRET";
  const ttlEnv = "SLAW_AGENT_JWT_TTL_SECONDS";
  const issuerEnv = "SLAW_AGENT_JWT_ISSUER";
  const audienceEnv = "SLAW_AGENT_JWT_AUDIENCE";
  ...
  it("falls back to BETTER_AUTH_SECRET when SLAW_AGENT_JWT_SECRET is absent", () => {
