 ...
 */
export function generateOrgChartMermaid(agents: SquadPortabilityManifest["agents"]): string | null {
...
function skillSourceLabel(skill: SquadPortabilityManifest["skills"][number]): string {
...
/**
 * Generate the README.md content for a squad export.
 */
export function generateReadme(
  ...
  lines.push(`# ${options.squadName}`);
  lines.push("");
  if (options.squadDescription) {
    lines.push(`> ${options.squadDescription}`);
    lines.push("");
  }
  ...
  lines.push("");
  lines.push("> This is an [Agent Squad](https://agentsquads.io) package from [Slaw](https://slaw.run)");
  lines.push("");
