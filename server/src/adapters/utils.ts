...
import * as serverUtils from "@slaw-ai/adapter-utils/server-utils";
export type { RunProcessResult } from "@slaw-ai/adapter-utils/server-utils";
...
export const buildSlawEnv = serverUtils.buildSlawEnv;
...
export function buildInvocationEnvForLogs(
  ...
  if (resolvedCommand) {
    merged[options.resolvedCommandEnvKey ?? "SLAW_RESOLVED_COMMAND"] =
