...
This note inventories the Slaw issues that point to the same UX class of problem:
...
Pattern: Slaw already has several places where the right fix was "show intent immediately, then reconcile," not "wait for refetch."
