...
- New config/env settings:
  - `SLAW_AGENT_JWT_SECRET`
  - `SLAW_AGENT_JWT_TTL_SECONDS` (default: `172800`)
  - `SLAW_AGENT_JWT_ISSUER` (default: `slaw`)
  - `SLAW_AGENT_JWT_AUDIENCE` (default: `slaw-api`)
...
1. In:
   ...
   inject `SLAW_API_KEY` from context token.
