# LLM Wiki Slaw Asset And Work-Product Security Gate

Status: accepted Phase 5 policy
Date: 2026-05-06
Owner: Security engineering
Scope: Slaw-derived ingestion into the LLM Wiki before any asset or work-product content indexing ships

## Decision

Phase 5 remains **fail-closed** for Slaw assets and work products.

- Slaw-derived **text extraction is allowed only** for issue titles/descriptions, issue comments, and issue documents.
- Slaw **assets/attachments** and **issue work products** are **metadata-only** in Phase 5.
...
These source kinds may contribute body text to Slaw-derived source bundles:
...
- metadata-only references built from allowlisted structured fields already stored in Slaw
...
- Every asset MIME type is treated as opaque for Slaw-derived indexing.
...
- non-default-space routing for Slaw-derived asset/work-product references
