...
This document defines the next-stage plan for Slaw company import/export.
...
3. a vendor-neutral base package spec for agent-company runtimes, not just Slaw
...
- A user can point Slaw at a local folder or GitHub repo and import a company package without any registry.
...
- `slaw company export <company-id> --out <path>`
- `slaw company import <path-or-url> --dry-run`
- `slaw company import <path-or-url> --target existing -C <company-id>`
