...
- Make it normal to have Claude/Codex help complete setup.
...
2. Is this a new squad, an existing squad, or a service/agency team?
...
- “Talk to the Squad Lead” feeling for the user.
- Every conversation ends up attached to a real squad object.
...
type ThreadScope = "squad" | "project" | "issue" | "agent";
```

Examples:

- On dashboard: “Ask the Squad Lead for a hiring plan” → creates a `strategy` issue/thread scoped to the squad.
...
- A user can “ask Squad Lead” from the dashboard and receive a response in a squad-scoped thread.
...
- consumer chat UX
- model marketplace
- general-purpose assistant unrelated to squad context
...
- At squad level: “who is active, what are they doing, what is moving between teams”
...
- easy discoverability from the issue/run/squad pages
...
- simple invite flow
- squad-level isolation preserved
...
- Team of 3 can use one shared Slaw instance.
- Every user action is attributed correctly in activity.
- Squad membership boundaries are enforced.
- Viewer cannot mutate; operator/admin can.

### Non-goals

- enterprise RBAC
- cross-squad matrix permissions
...
Slaw should manage the **issue → workspace → preview/PR → review handoff** lifecycle, but leave diffs/review/merge to external tools.
...
execution:
  ...
  preview:
    command: "pnpm dev --port $SLAW_PREVIEW_PORT"
    healthPath: "/"
    ttlMinutes: 120
  vcs:
    provider: github
...
interface PluginManifest {
  ...
  surfaces: ("squad_home" | "issue_panel" | "agent_panel" | "sidebar")[];
  workerEntry: string;
  uiEntry: string;
}
```
...
- A chat plugin can converse without requiring chat to become the core Slaw product.
- Plugin permissions are squad-scoped and auditable.
...
- **Keep** Slaw as the board-level control plane.
...
[1]: https://github.com/slaw/slaw "https://github.com/slaw/slaw"
[2]: https://github.com/slaw/slaw/blob/master/doc/SPEC-implementation.md "https://github.com/slaw/slaw/blob/master/doc/SPEC-implementation.md"
[3]: https://github.com/slaw/slaw/issues/704 "https://github.com/slaw/slaw/issues/704"
[4]: https://github.com/slaw/slaw/blob/master/docs/deploy/tailscale-private-access.md "https://github.com/slaw/slaw/blob/master/docs/deploy/tailscale-private-access.md"
[5]: https://github.com/slaw/slaw/blob/master/docs/deploy/deployment-modes.md "https://github.com/slaw/slaw/blob/master/docs/deploy/deployment-modes.md"
[6]: https://github.com/slaw/slaw/issues/692 "https://github.com/slaw/slaw/issues/692"
[7]: https://github.com/slaw/slaw/blob/master/doc/DEVELOPING.md "https://github.com/slaw/slaw/blob/master/doc/DEVELOPING.md"
[8]: https://github.com/slaw/slaw/blob/master/doc/PRODUCT.md "https://github.com/slaw/slaw/blob/master/doc/PRODUCT.md"
[9]: https://github.com/slaw/slaw/blob/master/docs/start/core-concepts.md "https://github.com/slaw/slaw/blob/master/docs/start/core-concepts.md"
