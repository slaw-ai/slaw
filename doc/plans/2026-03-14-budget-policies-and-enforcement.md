...
Slaw already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model Slaw should implement next.

## Product Goals

Slaw should let operators:
...
For the next implementation pass, Slaw should enforce these defaults:
...
Slaw should separate subscription-included usage from billed spend:
...
Slaw should have two threshold classes:
...
Slaw must know that a project is budget-paused and enforce it.
...
Slaw must also block execution before new work starts.
