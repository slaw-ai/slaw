...
This is intentionally separate from the normal Slaw dev image.
...
```sh
review-checkout-pr slaw/slaw 432
cd /work/checkouts/slaw-slaw/pr-432
```
...
## Preview the Slaw app from the PR
...
- Slaw's embedded PostgreSQL and local storage stay inside the container home volume via `SLAW_HOME=/home/reviewer/.slaw-review`.
