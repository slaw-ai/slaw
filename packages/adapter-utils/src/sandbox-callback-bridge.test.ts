...
describe("sandbox callback bridge", () => {
  ...
  it("permits the documented heartbeat surface and denies unrelated routes", () => {
    const allowed: Array<{ method: string; path: string }> = [
      ...
      { method: "GET", path: "/api/squads/co-1" },
      { method: "GET", path: "/api/squads/co-1/dashboard" },
      { method: "GET", path: "/api/squads/co-1/agents" },
      { method: "GET", path: "/api/squads/co-1/issues" },
      { method: "GET", path: "/api/squads/co-1/projects" },
      { method: "GET", path: "/api/squads/co-1/goals" },
      { method: "GET", path: "/api/squads/co-1/org" },
      { method: "GET", path: "/api/squads/co-1/approvals" },
      { method: "GET", path: "/api/squads/co-1/routines" },
      { method: "GET", path: "/api/squads/co-1/skills" },
      ...
      { method: "POST", path: "/api/squads/co-1/issues" },
      ...
      { method: "POST", path: "/api/squads/co-1/approvals" },
      ...
      { method: "POST", path: "/api/squads/co-1/routines" },
    ...
    const denied: Array<{ method: string; path: string }> = [
      ...
      { method: "POST", path: "/api/squads/co-1/agents" },
      ...
      { method: "POST", path: "/api/squads/co-1/exports" },
      { method: "POST", path: "/api/squads/co-1/imports/apply" },
      { method: "POST", path: "/api/squads/co-1/archive" },
      ...
      { method: "POST", path: "/api/squads/co-1/logo" },
      { method: "GET", path: "/api/squads/co-1/secrets" },
