...
const PLUGIN_ID = "slaw.fake-sandbox-provider";
...
const manifest: SlawPluginManifestV1 = {
  ...
  description:
    "First-party deterministic sandbox provider plugin for exercising Slaw provider-plugin integration without external infrastructure.",
  author: "Slaw",
