...
export const cloudUpstreamRuns = pgTable(
  "cloud_upstream_runs",
  {
    ...
    summary: jsonb("summary").$type<import("@slaw/shared").CloudUpstreamSummaryCount[]>().notNull().default([]),
    warnings: jsonb("warnings").$type<import("@slaw/shared").CloudUpstreamWarning[]>().notNull().default([]),
    conflicts: jsonb("conflicts").$type<import("@slaw/shared").CloudUpstreamConflict[]>().notNull().default([]),
    events: jsonb("events").$type<import("@slaw/shared").CloudUpstreamRunEvent[]>().notNull().default([]),
