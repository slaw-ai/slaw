...
export const workspaceOperations = pgTable(
  ...
  (table) => ({
    squadRunStartedIdx: index("workspace_operations_squad_run_started_idx").on(
      table.squadId,
      table.heartbeatRunId,
      table.startedAt,
    ),
    squadWorkspaceStartedIdx: index("workspace_operations_squad_workspace_started_idx").on(
      table.squadId,
