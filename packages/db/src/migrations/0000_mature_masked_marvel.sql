...
--> statement-breakpoint
ALTER TABLE "activity_log" ADD CONSTRAINT "activity_log_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "agent_api_keys" ADD CONSTRAINT "agent_api_keys_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "approvals" ADD CONSTRAINT "approvals_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "cost_events" ADD CONSTRAINT "cost_events_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "goals" ADD CONSTRAINT "goals_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "heartbeat_runs" ADD CONSTRAINT "heartbeat_runs_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "issue_comments" ADD CONSTRAINT "issue_comments_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "issues" ADD CONSTRAINT "issues_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "projects" ADD CONSTRAINT "projects_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "activity_log_squad_created_idx" ON "activity_log" USING btree ("squad_id","created_at");--> statement-breakpoint
CREATE INDEX "agent_api_keys_key_hash_idx" ON "agent_api_keys" USING btree ("key_hash");--> statement-breakpoint
CREATE INDEX "agent_api_keys_squad_agent_idx" ON "agent_api_keys" USING btree ("squad_id","agent_id");--> statement-breakpoint
CREATE INDEX "agents_squad_status_idx" ON "agents" USING btree ("squad_id","status");--> statement-breakpoint
CREATE INDEX "agents_squad_reports_to_idx" ON "agents" USING btree ("squad_id","reports_to");--> statement-breakpoint
CREATE INDEX "approvals_squad_status_type_idx" ON "approvals" USING btree ("squad_id","status","type");--> statement-breakpoint
CREATE INDEX "cost_events_squad_occurred_idx" ON "cost_events" USING btree ("squad_id","occurred_at");--> statement-breakpoint
CREATE INDEX "cost_events_squad_agent_occurred_idx" ON "cost_events" USING btree ("squad_id","agent_id","occurred_at");--> statement-breakpoint
CREATE INDEX "goals_squad_idx" ON "goals" USING btree ("squad_id");--> statement-breakpoint
CREATE INDEX "heartbeat_runs_squad_agent_started_idx" ON "heartbeat_runs" USING btree ("squad_id","agent_id","started_at");--> statement-breakpoint
CREATE INDEX "issue_comments_issue_idx" ON "issue_comments" USING btree ("issue_id");--> statement-breakpoint
CREATE INDEX "issue_comments_squad_idx" ON "issue_comments" USING btree ("squad_id");--> statement-breakpoint
CREATE INDEX "issues_squad_status_idx" ON "issues" USING btree ("squad_id","status");--> statement-breakpoint
CREATE INDEX "issues_squad_assignee_status_idx" ON "issues" USING btree ("squad_id","assignee_agent_id","status");--> statement-breakpoint
CREATE INDEX "issues_squad_parent_idx" ON "issues" USING btree ("squad_id","parent_id");--> statement-breakpoint
CREATE INDEX "issues_squad_project_idx" ON "issues" USING btree ("squad_id","project_id");--> statement-breakpoint
CREATE INDEX "projects_squad_idx" ON "projects" USING btree ("squad_id");