...
ALTER TABLE "workspace_runtime_services" ADD CONSTRAINT "workspace_runtime_services_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "workspace_runtime_services_squad_workspace_status_idx" ON "workspace_runtime_services" USING btree ("squad_id","project_workspace_id","status");--> statement-breakpoint
CREATE INDEX "workspace_runtime_services_squad_project_status_idx" ON "workspace_runtime_services" USING btree ("squad_id","project_id","status");--> statement-breakpoint
...
CREATE INDEX "workspace_runtime_services_squad_updated_idx" ON "workspace_runtime_services" USING btree ("squad_id","updated_at");