...
--> statement-breakpoint
ALTER TABLE "document_revisions" ADD CONSTRAINT "document_revisions_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "documents" ADD CONSTRAINT "documents_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "issue_documents" ADD CONSTRAINT "issue_documents_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "document_revisions_squad_document_created_idx" ON "document_revisions" USING btree ("squad_id","document_id","created_at");--> statement-breakpoint
CREATE INDEX "documents_squad_updated_idx" ON "documents" USING btree ("squad_id","updated_at");--> statement-breakpoint
CREATE INDEX "documents_squad_created_idx" ON "documents" USING btree ("squad_id","created_at");--> statement-breakpoint
CREATE UNIQUE INDEX "issue_documents_squad_issue_key_uq" ON "issue_documents" USING btree ("squad_id","issue_id","key");--> statement-breakpoint
CREATE UNIQUE INDEX "issue_documents_document_uq" ON "issue_documents" USING btree ("document_id");--> statement-breakpoint
CREATE INDEX "issue_documents_squad_issue_updated_idx" ON "issue_documents" USING btree ("squad_id","issue_id","updated_at");