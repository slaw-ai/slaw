...
ALTER TABLE "execution_workspaces" ADD CONSTRAINT "execution_workspaces_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "issue_work_products" ADD CONSTRAINT "issue_work_products_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "execution_workspaces_squad_project_status_idx" ON "execution_workspaces" USING btree ("squad_id","project_id","status");--> statement-breakpoint
CREATE INDEX "execution_workspaces_squad_project_workspace_status_idx" ON "execution_workspaces" USING btree ("squad_id","project_workspace_id","status");--> statement-breakpoint
CREATE INDEX "execution_workspaces_squad_source_issue_idx" ON "execution_workspaces" USING btree ("squad_id","source_issue_id");--> statement-breakpoint
CREATE INDEX "execution_workspaces_squad_last_used_idx" ON "execution_workspaces" USING btree ("squad_id","last_used_at");--> statement-breakpoint
CREATE INDEX "execution_workspaces_squad_branch_idx" ON "execution_workspaces" USING btree ("squad_id","branch_name");--> statement-breakpoint
CREATE INDEX "issue_work_products_squad_issue_type_idx" ON "issue_work_products" USING btree ("squad_id","issue_id","type");--> statement-breakpoint
CREATE INDEX "issue_work_products_squad_execution_workspace_type_idx" ON "issue_work_products" USING btree ("squad_id","execution_workspace_id","type");--> statement-breakpoint
CREATE INDEX "issue_work_products_squad_provider_external_id_idx" ON "issue_work_products" USING btree ("squad_id","provider","external_id");--> statement-breakpoint
CREATE INDEX "issue_work_products_squad_updated_idx" ON "issue_work_products" USING btree ("squad_id","updated_at");--> statement-breakpoint
...
CREATE INDEX "issues_squad_project_workspace_idx" ON "issues" USING btree ("squad_id","project_workspace_id");--> statement-breakpoint
CREATE INDEX "issues_squad_execution_workspace_idx" ON "issues" USING btree ("squad_id","execution_workspace_id");--> statement-breakpoint
...
CREATE INDEX "project_workspaces_squad_shared_key_idx" ON "project_workspaces" USING btree ("squad_id","shared_workspace_key");--> statement-breakpoint
...
CREATE INDEX "workspace_runtime_services_squad_execution_workspace_status_idx" ON "workspace_runtime_services" USING btree ("squad_id","execution_workspace_id","status");