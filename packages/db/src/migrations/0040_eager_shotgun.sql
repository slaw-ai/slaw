CREATE UNIQUE INDEX IF NOT EXISTS "issues_open_routine_execution_uq" ON "issues" USING btree ("squad_id","origin_kind","origin_id") WHERE "issues"."origin_kind" = 'routine_execution'
