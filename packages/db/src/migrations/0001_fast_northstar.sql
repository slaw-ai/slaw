...
ALTER TABLE "agent_runtime_state" ADD CONSTRAINT "agent_runtime_state_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "agent_wakeup_requests" ADD CONSTRAINT "agent_wakeup_requests_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "heartbeat_run_events" ADD CONSTRAINT "heartbeat_run_events_squad_id_squads_id_fk" FOREIGN KEY ("squad_id") REFERENCES "public"."squads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "agent_runtime_state_squad_agent_idx" ON "agent_runtime_state" USING btree ("squad_id","agent_id");--> statement-breakpoint
CREATE INDEX "agent_runtime_state_squad_updated_idx" ON "agent_runtime_state" USING btree ("squad_id","updated_at");--> statement-breakpoint
CREATE INDEX "agent_wakeup_requests_squad_agent_status_idx" ON "agent_wakeup_requests" USING btree ("squad_id","agent_id","status");--> statement-breakpoint
CREATE INDEX "agent_wakeup_requests_squad_requested_idx" ON "agent_wakeup_requests" USING btree ("squad_id","requested_at");--> statement-breakpoint
...
CREATE INDEX "heartbeat_run_events_squad_run_idx" ON "heartbeat_run_events" USING btree ("squad_id","run_id");--> statement-breakpoint
CREATE INDEX "heartbeat_run_events_squad_created_idx" ON "heartbeat_run_events" USING btree ("squad_id","created_at");