...
- dangerouslySkipPermissions (boolean, optional, default true): pass --dangerously-skip-permissions to claude; defaults to true because Slaw runs Claude in headless --print mode where interactive permission prompts cannot be answered
