...
Use when:
- You want Slaw to run the Gemini CLI locally on the host machine
...
- Slaw auto-injects local skills into \`~/.gemini/skills/\` via symlinks, so the CLI can discover both credentials and skills in their natural location.
