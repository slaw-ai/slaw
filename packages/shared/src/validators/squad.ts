...
const attachmentMaxBytesSchema = z
  ...
  .int()
  .min(1)
  .max(MAX_SQUAD_ATTACHMENT_MAX_BYTES);
...
export const updateSquadSchema = createSquadSchema
  .partial()
  .extend({
...
export const updateSquadBrandingSchema = z
  .object({
...
export type UpdateSquadBranding = z.infer<typeof updateSquadBrandingSchema>;
